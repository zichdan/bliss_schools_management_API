...
from ..models.users import User, Student, Teacher, Student,Admin
...
class GetStudentEnrollment(Resource):
    ...
    @course_namespace.doc(
        description= ''' "Get all students enrolled for a course"
         This endpoint is accessible to a Teacher and an Admin . 
                It allows staff retrieve studentsregistered for a course
        ''',
        params = {
            'course_id': "The Course's ID"
        }
...
class StudentEnrollment(Resource):
    ...
    @course_namespace.doc(
        ...
        This endpoint allows Only an Admin to register a student to a new course
        ''')
